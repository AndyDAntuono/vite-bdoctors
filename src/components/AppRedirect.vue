...
<template>
  <button @click="goBack" class="border-0 bg-transparent mt-2">
...
button {
  ...
  svg {
    ...
    max-height: 100%;
    object-fit: contain;
    filter: brightness(0) saturate(100%) invert(20%) sepia(91%) saturate(1956%) hue-rotate(186deg) brightness(91%) contrast(101%);
  }
  &:hover {
    transform: scale(1.1);
  }
